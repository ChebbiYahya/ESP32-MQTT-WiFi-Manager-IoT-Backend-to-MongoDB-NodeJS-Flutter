...
- App Flutter qui affiche le temps réel (MQTT) et récupère l''historique (HTTP).
...
**Structure**
- `main.py` : code MicroPython de l''ESP32 (capteur + MQTT).
...
**Topics MQTT**
- `iot/esp32/sensor_data` : publication `{ "temperature": <int>, "humidity": <int> }`.
